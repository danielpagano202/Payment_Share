      ...
      {isOpen && (
        <div className="overlay">
          <div className="modal">
            ...
            <h2>Settings</h2>
            <p className="sectionTitle">Change Name</p>
            <p className="sectionTitle">Add users</p>
            {/* Textbox that will be used when first creating a group to add members */}
            <p className="sectionTitle">Remove users</p>
            {props.data.users.map(user => {
              return (
                <div className="userRow">
                <UserBar
                  key={user.firstName + user.lastName + user.icon}
                  data={{ user: user }}
                />
          ...
          <div onClick={closeModal} className="clear-overlay">
